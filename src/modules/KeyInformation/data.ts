...
export default {
  ...
  barcelona: [
    ...
    },
    {
      ...
      link: "#10-29",
      description:
        "An in-person hackathon open to anyone with some Nextflow knowledge. to develop nf-core. You’ll work on specific tasks in groups, collaborating on developing nf-core. Running in parallel to the training.",
    },
    {
