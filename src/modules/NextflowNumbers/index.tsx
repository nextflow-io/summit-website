              ...
              <div className="w-full flex flex-row">
                {featuredStats.featuredStatLeft && (
                  <div className="px-4 py-2 bg-black w-full text-white flex flex-row items-center">
                    <h3 className="h4 mr-4 leading-none">
                      {featuredStats.featuredStatLeft}
                    </h3>
                    <p className="max-w-[100px] text-xs md:text-base leading-tight">
            ...
            {stats.map((stat, index) => (
              <div key={index} className="border-b border-black py-2">
                <div className="flex flex-row items-center">
                  <h4 className="h4 mr-4 leading-none">
                    {stat.statNumber}
                  </h4>
                  <p className="text- md:text-lg leading-tight mb-0">
