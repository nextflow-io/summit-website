...
const SpeakerBox = ({
  ...
  return (
    <div className={`hover:cursor-pointer`}>
      ...
      <div
        className={`w-full h-full max-w-[350px] sm:max-w-[850px] top-[50%] left-[50%] fixed z-[999] p-4 border border-nextflow bg-brand max-h-[600px] md:max-h-[500px] my-2 overflow-y-scroll md:overflow-y-hidden`}
        style={
          isOpen
            ? {
                display: "block",
