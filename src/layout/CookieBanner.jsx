...
const CookieBanner = () => {
  ...
  return !isSSR && (
    <div className={classnames(
      'bg-gray-50 fixed bottom-0 w-full z-10 py-4 md:py-3',
      {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 row justify-center md:justify-end">
            <div className="col mt-4 md:mt-0">
              <Button  variant="secondary" size="sm" noShadow onClick={() => { acceptAll(false) }}>
                Keep only essential cookies
              </Button>
            </div>
            <div className="col mt-4 md:mt-0">
              <Button variant="primary" size="sm" noShadow onClick={() => { acceptAll(true) }}>
                Accept all cookies
              </Button>
            </div>
          </div>
