...
const TalksInstructionsPage = () => {
  return (
    <>
      <Seo title="Nextflow SUMMIT 2023 Talks Instructions" />
      <div className="py-16 bg-gray-900 text-white">
        <div className="container-md">
          ...
          <div className="bg-black border border-gray-800 rounded-md p-8 mt-10">
            <h2 className="typo-h3">Talks</h2>
            <h3 className="typo-intro mt-8">Formats</h3>
            <List type="bullet" iconClassName="text-white" className="mt-4" shrink>
              <List.Item className="typo-body">Long-form - 30 min total, including time for Q&A</List.Item>
              <List.Item className="typo-body">Lightning - 15 min total, including time for Q&A</List.Item>
            </List>
