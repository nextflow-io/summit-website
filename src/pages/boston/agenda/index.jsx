        ...
        <div className="row">
          <div className="col-full lg:col-6 mt-4">
            <Card>
              ...
              <p className="typo-intro text-green-300 mt-4">1.5 days · 50 people · hackathon</p>
              <p className="typo-body mt-4">The program will be available once the call for abstracts has closed.</p>
              <div className="mt-4">
                <span className="typo-body bg-gray-800 rounded-sm py-2 px-4">Program coming soon</span>
                {/*
          ...
          <div className="col-full lg:col-6 mt-8 md:mt-4">
            <Card>
              ...
              <p className="typo-intro text-green-300 mt-4">1.5 days · 100 people · talks, networking, and more</p>
              <p className="typo-body mt-4">The program will be available once the call for abstracts has closed.</p>
              <div className="mt-4">
                <span className="typo-body bg-gray-800 rounded-sm py-2 px-4">Program coming soon</span>
                {/*
      ...
      <div className="container-lg text-white">
        <div className="row">
          <div className="col-full lg:col-5">
            <Image image={getImage(data.redPattern)} alt="Nextflow SUMMIT speakers" className="h-full w-full" />
          </div>
          <div className="col-full lg:col-6 py-16">
            <div className="px-4 lg:px-12">
              <h2 className="typo-display1">20+ Speakers</h2>
              <p className="typo-body mt-2">
                This year we are thrilled to have <strong>Erik Garrison</strong> join us as keynote speaker, author of
                the recent <Link to="https://www.nature.com/articles/s41586-023-05896-x">Nature paper</Link>{' '}
                <em>“A draft human pangenome reference”</em>.
              </p>
              <p className="typo-body mt-2">
                Stay tuned for more exciting announcements of our distinguished speakers. Until then, you can watch the
                talks from last year below:
              </p>
              <div className="mt-8">
                <Button
