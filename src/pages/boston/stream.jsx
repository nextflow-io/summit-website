...
const StreamPage = () => {
  ...
  return (
    <>
      <Seo title="Nextflow Summit 2023 Boston Live Stream" />
      <div
      ...
      >
        <div className="container-lg text-center">
          ...
          <Button
            to="https://youtube.com/playlist?list=PLPZ8WHdZGxmVeXGTg6aFNlaeTEMTs3GOt"
            variant="primary"
            size="md"
            arrow
            className="mx-3"
              ...
              <div className="row flex-wrap lg:flex-nowrap">
                ...
                <div className="col-full lg:col-6 lg:ml-1/12">
                  <div className="relative border border-green-300 rounded-sm overflow-hidden p-1 bg-black">
                    <YoutubeIframe listId="PLPZ8WHdZGxmVeXGTg6aFNlaeTEMTs3GOt"></YoutubeIframe>
                  </div>
                </div>
              </div>
            </div>
