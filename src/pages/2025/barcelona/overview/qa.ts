export default {
  ...
  {
    question: "Can I attend both Nextflow Training and nf-core Hackathon Barcelona 2025?",
    answer:
      `Nextflow Training and nf-core Hackathon run simultaneously over October 28-29, so you can only register to attend one.
        `
  },
  {
