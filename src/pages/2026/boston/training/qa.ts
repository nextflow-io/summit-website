export default {
  main: [
    ...
    },
    {
      ...
      answer:
        `The training will run for two full days, from 9 AM to 5 PM. Trainees are expected to attend both days to get the full benefit of the program. Please check the <a href="/2026/boston/agenda">online agenda</a> for updates.`
    },
    {
