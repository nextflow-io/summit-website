          ...
          <div className="row lg:flex-nowrap">
            <div className="col-full lg:col-6">
              ...
              <p className="typo-body mt-4">
                Past events have provided insights into Nextflow&apos;s origins,
                development, and its applications in various domains,
                highlighting its potential and impact on scientific research,
